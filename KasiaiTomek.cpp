...
{
    srand (time (NULL));
    int n = 0, random, test = 0, pomiar = 0;
    float losowy_czas = 0, malejacy_czas = 0, rosnacy_czas = 0, staly_czas = 0, vksztaltny_czas = 0, helper = 0;
    float wyniki[5][60];
    ...
    while (test < 60)
    {
        ...
        while (pomiar < 10)
        {
            ...
            if (test < 15)
            {
                ...
                rosnacy_czas += ((clock() - helper) / CLOCKS_PER_SEC);
                ...
                staly_czas += ((clock() - helper) / CLOCKS_PER_SEC);
                ...
                vksztaltny_czas += ((clock() - helper) / CLOCKS_PER_SEC);
        ...
        pomiar = 0;
        float losowy_czas = 0, malejacy_czas = 0, rosnacy_czas = 0, staly_czas = 0, vksztaltny_czas = 0;
        cout << test << endl;
        test++;
    }
    ...
    for (int i = 0; i < 5; i++)
    {
        ...
        for (int j = 0; j < 15; j++)
        {
            plik << fixed << setprecision(6) << wyniki[i][j]/10.0 << ";";
        }
        plik << endl;
    }
